  ...
  render(){
    return(
      <div className="container-fluid" id="pantalla_2" style={{ backgroundImage: `url(${Foto2})` }}>
        ...
        <div className="row">
        <div className="col">
        <p className="texto_1 text-center">Desde aquí puedes comunicarte con el equipo de desarrollo de Alto Voltaje</p>
        </div>
        </div>   
        <br/>
        <CampoSoporte1 input1="Nombre" input2="Email"/>
        <a href="/iniciar-sesion"><svg width="4em" height="4em" viewBox="0 0 16 16" className="bi bi-arrow-left text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
